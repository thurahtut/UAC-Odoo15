odoo.define("advanced_web_domain_widget.TerabitsDomainSelector", function (require) {
    ...
    var TerabitsDomainLeaf = TerabitsDomainNode.extend({
        ...
        start: function () {
            ...
            if (!this.readonly && this.valueWidget && this.operator != "date_filter") {
                // In edit mode, place the value widget if any
                this.$(".o_domain_leaf_value_input").replaceWith(
                  this.valueWidget.$el
                );
              }
            if(this.operator == "date_filter") {}
        ...
        _changeValue: function (value, silent) {
            ...
            if (selectedField.type === "boolean") {
                ...
                if ((couldNotParse || _.isBoolean(this.value)) && this.operator != "date_filter") {
